      ...
      {!loading && business && (
        <>
          ...
          {demoTabs.length > 1 && demoTabs.some(t => t.id === business.id) && (
            <div style={{
              background: C.warmWhite, borderBottom: `1px solid ${C.sand}`,
            ...
            <FadeIn>
              ...
              {claimToken && business.tier === 'premium' && !business.googlePlaceId && (
                <div style={{
                  ...
                  border: `1.5px solid ${C.lakeBlue}30`,
                  padding: '22px 24px', marginBottom: 14,
                }}>
                  <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                    <div style={{ width: 44, height: 44, borderRadius: 12, background: `${C.lakeBlue}18`, border: `1.5px solid ${C.lakeBlue}30`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
