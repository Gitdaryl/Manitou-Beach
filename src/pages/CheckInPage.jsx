  ...
  return (
    <div style={{ fontFamily: "'Libre Franklin', sans-serif", background: C.night, color: C.cream, minHeight: '100vh' }}>
      ...
      <div style={{ padding: '20px 24px 16px', borderBottom: `1px solid ${C.dusk}`, textAlign: 'center' }}>
        <img src="/images/yeti/yetickets_sign.webp" alt="Yetickets" style={{ height: 72, maxWidth: 320, objectFit: 'contain', display: 'block', margin: '0 auto 10px' }} />
              ...
              <>
                ...
                {!loading && (
                  <div style={{ textAlign: 'center', padding: '28px 0 20px' }}>
                    <img src="/images/yeti/yetickets_doorman.webp" alt="" style={{ width: 220, height: 220, objectFit: 'contain', display: 'block', margin: '0 auto 14px' }} />
