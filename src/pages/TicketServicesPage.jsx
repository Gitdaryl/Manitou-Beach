  ...
  return (
    <div style={{ fontFamily: "'Libre Franklin', sans-serif", background: C.cream, color: C.text, overflowX: "hidden" }}>
      ...
      <div style={{ background: C.night, borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "9px 24px", display: "flex", alignItems: "center", justifyContent: "center", gap: 28, flexWrap: "wrap" }}>
        ...
        <a href="/events" style={{ fontSize: 12, color: C.sunsetLight, fontFamily: "'Libre Franklin', sans-serif", fontWeight: 600, textDecoration: "none", whiteSpace: "nowrap" }}>See Events →</a>
      ...
      <section style={{ background: `linear-gradient(160deg, ${C.night} 0%, ${C.dusk} 55%, ${C.night} 100%)`, padding: "clamp(90px, 15vw, 160px) 24px clamp(60px, 10vw, 110px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <FadeIn>
          <img src="/images/yeti/yetickets_sign.webp" alt="Yetickets" style={{ width: "100%", maxWidth: 520, objectFit: "contain", marginBottom: 32 }} />
        ...
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 8 }}>
              <img src="/images/yeti/yetickets_get_tickets.webp" alt="Yetickets box office" style={{ width: 260, height: 260, objectFit: "contain" }} />
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 60, alignItems: "center" }}>
            <FadeIn>
              <div style={{ textAlign: "center" }}>
                <img
                  src="/images/yeti/yetickets_pci.webp"
          ...
          {onboarded ? (
            <FadeIn>
              <div style={{ textAlign: "center", padding: "60px 32px", background: "rgba(255,255,255,0.04)", borderRadius: 20, border: "1px solid rgba(255,255,255,0.1)" }}>
                ...
                <Btn href="/events" variant="outline" style={{ whiteSpace: "nowrap" }}>See Events →</Btn>
              </div>
            </FadeIn>
          ) : refresh ? (
            <FadeIn>
