...
function EventList({ phone, token }) {
  ...
  return (
    <div>
      ...
      <AddToHomeScreen
        icon={CONTROL_SURFACES.organizer.install.icon}
        heading={CONTROL_SURFACES.organizer.install.heading}
        body={CONTROL_SURFACES.organizer.install.body}
        storageKey={CONTROL_SURFACES.organizer.install.storageKey}
        style={{ marginTop: 28 }}
      />
...
export default function MyEventsPage() {
  ...
  const organizerInstall = CONTROL_SURFACES.organizer.install;
  useInstallable({
    manifestHref: organizerInstall.manifest({ phone, token }),
    icon: organizerInstall.icon,
    appTitle: organizerInstall.appTitle,
    themeColor: organizerInstall.themeColor,
    documentTitle: 'My Events - Manitou Beach',
  });
